import { L as h, S as k, aS as m, C as n, aU as r, aV as w, aT as x } from "./BJowY05t.js";
...
const C = (g, l, c, d, p = !1) => {
    const b = m(),
      ...
      f = n(() => {
        ...
        const e = r(l),
          ...
          a = r(d);
        return h(
          (e == null ? void 0 : e.strategy) || ((o = t.ui) == null ? void 0 : o.strategy),
          a ? { wrapper: a } : {},
          e || {},
          p ? k(t.ui, g, {}) : {},
          y || {},
  ...
  i = {
    ...
    option: {
      ...
      avatar: { base: "flex-shrink-0", size: "2xs" },
...
({ ...i, option: { ...i.option }, arrow: { ...s } });
export { s as a, C as u };
